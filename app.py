...
st.link_button("SINGIFY", "https://exploreai.streamlit.app/singify")

st.link_button("AI PODCAST", "https://exploreai.streamlit.app/aipodcast")

st.link_button("CSV ANALYSIS", "https://csvvisualisation.streamlit.app")
